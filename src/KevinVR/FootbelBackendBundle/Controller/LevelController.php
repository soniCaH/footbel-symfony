...
class LevelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $levels = $em->getRepository('FootbelBackendBundle:Level')->findAll();
    ...
    {
        $level = new Level();
        $form = $this->createForm('KevinVR\FootbelBackendBundle\Form\LevelType', $level);
    ...
    {
        $deleteForm = $this->createDeleteForm($level);
        $editForm = $this->createForm('KevinVR\FootbelBackendBundle\Form\LevelType', $level);
