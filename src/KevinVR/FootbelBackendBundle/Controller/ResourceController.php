...
use KevinVR\FootbelBackendBundle\Form\ResourceType;
...
class ResourceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $resources = $em->getRepository('FootbelBackendBundle:Resource')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('KevinVR\FootbelBackendBundle\Form\ResourceType', $resource);
    ...
    {
        $deleteForm = $this->createDeleteForm($resource);
        $editForm = $this->createForm('KevinVR\FootbelBackendBundle\Form\ResourceType', $resource);
