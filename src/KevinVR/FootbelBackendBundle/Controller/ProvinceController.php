...
use KevinVR\FootbelBackendBundle\Form\ProvinceType;
...
class ProvinceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $provinces = $em->getRepository('FootbelBackendBundle:Province')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('KevinVR\FootbelBackendBundle\Form\ProvinceType', $province);
    ...
    {
        $deleteForm = $this->createDeleteForm($province);
        $editForm = $this->createForm('KevinVR\FootbelBackendBundle\Form\ProvinceType', $province);
