...
use KevinVR\FootbelBackendBundle\Form\ResourceTypeType;
...
class ResourceTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $resourceTypes = $em->getRepository('FootbelBackendBundle:ResourceType')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('KevinVR\FootbelBackendBundle\Form\ResourceTypeType', $resourceType);
    ...
    {
        $deleteForm = $this->createDeleteForm($resourceType);
        $editForm = $this->createForm('KevinVR\FootbelBackendBundle\Form\ResourceTypeType', $resourceType);
