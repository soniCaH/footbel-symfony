...
class SeasonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $seasons = $em->getRepository('FootbelBackendBundle:Season')->findAll();
    ...
    {
        $season = new Season();
        $form = $this->createForm('KevinVR\FootbelBackendBundle\Form\SeasonType', $season);
    ...
    {
        $deleteForm = $this->createDeleteForm($season);
        $editForm = $this->createForm('KevinVR\FootbelBackendBundle\Form\SeasonType', $season);
