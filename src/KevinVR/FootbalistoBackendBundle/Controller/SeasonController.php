...
use KevinVR\FootbalistoBackendBundle\Form\SeasonType;
...
class SeasonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $seasons = $em->getRepository('FootbalistoBackendBundle:Season')->findAll();
    ...
    {
        $season = new Season();
        $form = $this->createForm('KevinVR\FootbalistoBackendBundle\Form\SeasonType', $season);
    ...
    {
        $deleteForm = $this->createDeleteForm($season);
        $editForm = $this->createForm('KevinVR\FootbalistoBackendBundle\Form\SeasonType', $season);
